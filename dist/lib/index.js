...
var ZAPI = /** @class */ (function () {
    function ZAPI() {
        ...
        this.BASE_API_URL = this.BASE_URL + this.API_PATH;
    ...
    ZAPI.prototype.zqlSearch = function (query, fields) {
        return this.callZapiCloud.apply(void 0, ['POST', this.BASE_API_URL + "/zql/search?", 'application/json'].concat(__ZAPIcreds, [JSON.stringify({ 'zqlQuery': "" + query })])).then(function (searchResults) {
            var result = {
    ...
    ZAPI.prototype.createExecution = function (cycleId, projectId, versionId, issueId, testStatus, assignee) {
        ...
        return this.callZapiCloud.apply(void 0, ['POST', this.BASE_API_URL + "/execution", 'application/json'].concat(__ZAPIcreds, [JSON.stringify(body)])).then(function (createExecution) {
